/** Nova workspace shell: a compact authenticated navigation frame for the personal cloud. */
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">Access to this dashboard requires a passwordless email sign-in.</p>
          </div>
          <Button
