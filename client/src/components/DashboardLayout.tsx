...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-neutral-950 dark:bg-neutral-950 dark:text-neutral-50">
      <header className="sticky top-0 z-40 flex h-14 items-center justify-between border-b border-neutral-200/90 bg-white/90 px-4 shadow-[0_1px_12px_rgba(10,10,10,0.03)] backdrop-blur-xl dark:border-white/10 dark:bg-neutral-950/90 sm:px-5 lg:px-7">
