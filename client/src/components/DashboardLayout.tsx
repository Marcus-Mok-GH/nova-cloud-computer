...
import { LogOut, MessageSquareText, Moon, Plus, Search, Sun } from "lucide-react";
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="dashboard-shell flex h-dvh min-h-0 min-w-0 flex-col overflow-hidden bg-background text-foreground">
      ...
      <main className={`min-h-0 min-w-0 flex-1 ${isChatWorkspace ? "overflow-hidden pl-[224px] sm:pl-[260px] lg:pl-[292px]" : "overflow-y-auto overscroll-contain pb-6 pl-[176px] sm:pl-[204px] lg:pb-8 lg:pl-[228px]"}`}>{children}</main>
