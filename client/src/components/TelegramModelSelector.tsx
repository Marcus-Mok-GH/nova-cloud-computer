  ...
  return (
    <section className="rounded-2xl border bg-card p-5 text-card-foreground shadow-sm sm:p-7">
      ...
      <div className="mt-6 rounded-2xl border bg-muted/20 p-4">
        <div className="flex items-center gap-2 text-sm font-bold"><Sparkles className="size-4 text-[oklch(0.72 0.015 250)]" /> Available NVIDIA models</div>
        {settings.isLoading ? (
          ...
          <select
            ...
            className="mt-4 w-full rounded-xl border border-input bg-background px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-[oklch(0.72 0.015 250)]/30"
          >
