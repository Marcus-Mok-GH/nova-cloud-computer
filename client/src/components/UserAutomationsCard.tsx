...
export default function UserAutomationsCard() {
  ...
  return <section className="rounded-2xl border bg-card p-5 text-card-foreground shadow-sm sm:p-7">
    <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
      ...
      <div className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#f97316]/10 text-[#f97316]"><Zap size={22} /></div>
    </div>
    <div className="mt-6 rounded-2xl border bg-muted/20 p-5">
      <div className="flex items-center gap-2"><Sparkles className="size-4 text-[#f97316]" /><p className="text-sm font-bold">What should Nova do?</p></div>
