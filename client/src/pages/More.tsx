    ...
    <DashboardLayout>
      <div className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
        <div className="mb-8 flex items-center gap-3">
          <div className="grid size-11 place-items-center rounded-2xl bg-[oklch(0.72 0.015 250)]/10 text-[oklch(0.72 0.015 250)]">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {nav.map(item => (
            ...
            >
              <div className="grid size-11 shrink-0 place-items-center rounded-xl bg-neutral-100 text-neutral-700 transition group-hover:bg-[oklch(0.72 0.015 250)]/10 group-hover:text-[oklch(0.72 0.015 250)] dark:bg-neutral-800 dark:text-neutral-200">
