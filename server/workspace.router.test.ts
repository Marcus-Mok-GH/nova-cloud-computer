...
type SettingsRecord = { activeProvider: "anthropic" | "openai" | "gemini" | "custom" | "mistral"; activeModelId: string; activeCustomModelId: number | null; workspaceRules: string | null };
