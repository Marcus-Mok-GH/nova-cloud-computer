...
export const NVIDIA_UNAVAILABLE_MESSAGE = "NVIDIA inference isn’t available right now, so I couldn’t run the agent. Please try again shortly. Explicit workspace actions remain available.";
